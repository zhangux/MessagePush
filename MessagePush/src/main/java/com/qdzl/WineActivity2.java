...
public class WineActivity2 extends FragmentActivity {
...
//    private Button btnF;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (App.getConfig() != null) {
            Toast.makeText(WineActivity2.this, App.getConfig().getServerip() + ":" + App.getConfig().getSocketport(), Toast.LENGTH_SHORT).show();
...
//                }
    ...
    public static void startActivity(Context context) {
        Intent in = new Intent(context, WineActivity2.class);
    ...
    private void sendClear() {
        SharedPreferences.Editor editor = WineActivity2.sp.edit();
